...
- Video-, Web- и Scene-проекты Workshop; Web-визуализаторы и Scene реагируют на музыку
- Обои из подписок Steam видны до установки; есть загрузка, прогресс и остановка
- Заполнение, масштаб, горизонтальное и вертикальное позиционирование обоев
- Повышенное разрешение WEB-обоев с регулируемым качеством
...
- `scene` запускаются настоящим рендерером установленного Wallpaper Engine и передаются в Spotifly как живой поток;
- подписанные, но ещё не установленные проекты можно скачать из галереи с отображением прогресса;
- повреждённые или удалённые из Workshop подписки помечаются как недоступные.

Для Video/Web нужен установленный проект. Для Scene и загрузки Workshop должен быть установлен и запущен Steam, а Wallpaper Engine должен принадлежать аккаунту. Spotifly не распространяет чужие проекты: файлы загружает сам Steam из ваших подписок.
